...
Phase 2 scope (after `mcp/` Phase 1 is functional): startup sequence (cwd → sub-scope → list_sessions → user confirm → resume/start), base dialogue loop, render templates.
