# dpd / server — MCP server

DPD MCP server. Stdio transport, Python 3.11+, sqlite storage (WAL mode).
...
Implementation begins in this directory under TDD discipline. `pyproject.toml`, `src/dpd_mcp_server/`, and `tests/` are added by the first RED test in Phase 1.
