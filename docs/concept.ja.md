...
```text
/dpd-import scopes/decompose-propagate.protocol/docs/dpd-v0.3.1-draft.md
...
/fcot
    └─ 各推論ノードに Falsification Chain-of-Thought を適用、
...
同じパイプラインを自分の spec や設計文書に適用できる — `/dpd-import → /dpd-fill → /fcot` は systematic な gap 分析の documented パターン。
