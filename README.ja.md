...
| `/dpd-dump` | グラフ全体を JSON で表示（YAML 1.2 互換） |
...
実際に MCP ツールで graph を組んだ walkthrough (transcript + graph 図 込み) を [`docs/examples.md`](docs/examples.md) (英語のみ) に集約しています。「こんな時に使います」の各ケースに対応:
